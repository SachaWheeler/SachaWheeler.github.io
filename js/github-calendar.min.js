  ...
  return function o(s, u, i) {
    function c(t, e) {
      ...
      var h = e("github-calendar-parser"),
        ...
        b = y(b), (m = m || {}).summary_text = m.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", m.cache = 1e3 * (m.cache || 86400), !1 === m.global_stats && (b.style.minHeight = "155px");var r = { content: "gh_calendar_content." + e, expire_at: "gh_calendar_expire." + e };m.proxy = m.proxy || function (e) {
          return fetch("https://api.bloggify.net/gh-calendar/?username=" + e).then(function (e) {
          // return fetch("https://github.com/users/SachaWheeler/contributions").then(function (e) {
            return e.text();
          });
